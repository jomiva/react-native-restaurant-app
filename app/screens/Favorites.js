      ...
      if (userLogged) {
        ...
        db.collection('favorites')
          ...
          .then((response) => {
            ...
            getDataRestaurant(idRestaurantArray).then((res) => {
...
const NotFoundRestaurants = () => {
  return (
    ...
    <View style={{ flex: 1, alignItems: 'center', justifyContent: 'center' }}>
      ...
      <Text style={{ fontSize: 20 }}>No tienes restaurantes en tu lista</Text>
    </View>
  );
};
...
const Restaurant = ({
  ...
  const confirmRemoveFavorite = () => {
    Alert.alert(
      ...
      'Está seguro que desea eliminarlo de favoritos?',
      [
        {
          text: 'Cancelar',
          style: 'cancel',
      ...
      .then((response) => {
        response.forEach((doc) => {
          ...
          db.collection('favorites')
            ...
            .catch(() => {
              setIsLoading(false);
              toastRef.current.show('Error al quitar el restaurant');
            });
        });
      });
  };
